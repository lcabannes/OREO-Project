...
class SFTDataset(Dataset):
    ...
    def collate_fn(self, item_list):
        ...
        input_ids = zero_pad_sequences(input_ids, self.padding_side, self.tokenizer.pad_token_id)
        attention_masks = zero_pad_sequences(attention_masks, self.padding_side)
