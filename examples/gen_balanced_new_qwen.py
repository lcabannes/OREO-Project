...
def main():
    ...
    params = SamplingParams(temperature=args.temperature, top_p=0.9, top_k=16, max_tokens=2048)
...
if __name__ == "__main__":
    ...
    if args.data == "GSM8K":
        ...
        chat_template = chat_template_math
